...
class Message(object):
    ...
    def shift_char(self, char, shift):
        ...
        '''
        #print(ascii(ord(char) + int(shift)))
        ordinario = ord(char)
        shift = int(shift)
        return chr((ordinario - 32 + shift) % 95 + 32)
    ...
    def apply_pad(self, pad):
        ...
        for i in range(len(pad)):
            texto_alt.append(self.shift_char(self.message[i], pad[i]))
        return "".join(texto_alt)
...
class PlaintextMessage(Message):
    ...
    def generate_pad(self):
        ...
        return [random.randint(0, 109) for _ in range(len(self.message))]
...
class EncryptedMessage(Message):
    def __init__(self, input_text):
        ...
        object inherits from Message. It has one attribute:
    ...
    def decrypt_message(self, pad):
        ...
        for i in range(len(texto)):
            message.append(self.shift_char(texto[i], - pad[i]))
        return PlaintextMessage("".join(message), pad)
