...
class Message(object):
    ...
    def apply_pad(self, pad):
        ...
        for i in range(len(self.input_text)):
            get = pad[i]
            result += self.shift_char(self.input_text[i],get)
...
class PlaintextMessage(Message):
    ...
    def generate_pad(self):
        ...
        for _ in range(len(self.input_text)):
            initial.append(random.randint(0,109))
...
class EncryptedMessage(Message):
    ...
    def decrypt_message(self, pad):
        ...
        original_text = self.apply_pad(inv_pad)

        return PlaintextMessage(original_text,pad)        