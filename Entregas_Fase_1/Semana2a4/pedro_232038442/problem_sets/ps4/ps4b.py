...
class PlaintextMessage(Message):
    ...
    def generate_pad(self):
        ...
        '''
        return [random.randrange(0, 110) for _ in range(len(self.message_text))]
