...
# Dictionary mapping function names from the above TestCase class to
# point value each test is worth. Make sure these add up to 5!
point_values = {
    'test_has_player_won' : .25,
    'test_has_player_won_repeated_letters' : .25,
    'test_has_player_won_empty_string': .25,
    'test_has_player_won_empty_list': .25,
    'test_get_word_progress': .25,
    'test_get_word_progress_repeated_letters': .25,
    'test_get_word_progress_empty_string': .25,
    'test_get_word_progress_empty_list': .25,
    'test_get_available_letters': .30,
    'test_get_available_letters_empty_string': .30,
    'test_get_available_letters_empty_list': .30,
    'test_play_game_short': .70,
    'test_play_game_short_fail': .70,
    'test_play_game_wildcard': .70
}
