...
class Message(object):
    ...
    def shift_char(self, char, shift):
        ...
        #passing char to ascii 
        ascii_char = ord(char)


        encrypted_char = chr((ascii_char - 32 + shift) % 95 + 32)
    ...
    def apply_pad(self, pad):
        ...
        for i, char in enumerate(self.input_text):
            ...
            encrypted_letter = self.shift_char(char, pad[i])
            cyphertext += encrypted_letter
...
class PlaintextMessage(Message):
    ...
    def get_pad(self):
        ...
        #this function copies other variable and make the new one independent
...
class EncryptedMessage(Message):
    ...
    def decrypt_message(self, pad):
        ...
        for i, char in enumerate(self.input_text):
            ...
            decrypted_char = self.shift_char(char, -pad[i])
            plaintextmessage += decrypted_char
        
        
        return PlaintextMessage(plaintextmessage, pad)
