...
class Message(object):
    ...
    def shift_char(self, char, shift):
        ...
        char_code = ord(char)
        if 32 <= char_code <= 126:
            shifted_code = (char_code - 32 + shift) % 95 + 32
...
class EncryptedMessage(Message):
    ...
    def decrypt_message(self, pad):
        ...
        '''
        negative_pad = [-s for s in pad]
        plaintext_string = self.apply_pad(negative_pad)
        
        return PlaintextMessage(plaintext_string, pad)
